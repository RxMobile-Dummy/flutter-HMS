...
import 'package:hospital_management_staff/feature/profile/presentation/pages/staff_detail_screen.dart';
import 'package:hospital_management_staff/feature/profile/presentation/pages/update_staff_profile_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      staffId  = int.parse(prefs.getString(CommonKeys.K_Id) ?? "");
      await _getProfile(staffId!);
    });
    super.initState();
  }
        ...
        children: [
          (getProfileModel.data != null) ? Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),*/
              Text(
                "Nrs. ${getProfileModel.data?.firstName} ${getProfileModel.data?.lastName}",
