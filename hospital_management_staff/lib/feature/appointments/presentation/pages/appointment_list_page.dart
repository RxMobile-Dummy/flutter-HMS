...
import 'package:hospital_management_staff/feature/appointments/presentation/pages/appointment_detail_page.dart';
                      ...
                      Expanded(child: TextButton(
                        onPressed: () async {
                          if(_formKey.currentState!.validate()){
                            ...
                            await _getAppointment("",filterDateController.text);
                          }
                        },
                        child:  Text(
                          Strings.kApplyFilter,
              ...
              onTap: () {
                Future.delayed(Duration.zero, () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            AppointmentDetailsPage(index: index,getAppointmentModel: getAppointmentModel,)),
                  );
                });
              },
              child: Padding(
